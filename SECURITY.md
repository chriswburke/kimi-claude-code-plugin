...
Treat the `CLAUDE_PLUGIN_DATA` state directory as private; do not attach its contents to a report or move it while work is active. Read the [Kimi security model](./docs/security-model.md) for documented trust boundaries and containment limits.
