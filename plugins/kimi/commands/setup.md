---
description: Check Kimi Code installation and configuration
argument-hint: "[--json]"
  ...
  PreToolUse:
    - matcher: "*"
      hooks:
        - type: command
          command: node
          args: ["${CLAUDE_PLUGIN_ROOT}/scripts/tool-gate.mjs", "mcp__plugin_kimi_companion__setup"]
---

The optional output flag is appended below under `ARGUMENTS:`. Call
`mcp__plugin_kimi_companion__setup` exactly once and pass that complete value
